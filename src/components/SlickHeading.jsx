    ...
    var settings = {
      ...
      return (
        <div className="w-full flex flex-col justify-center items-center">
          ...
          <motion.a
            href={"/about"}
            className="relative text-md md:text-lg text-center p-2 w-32 mt-10 md:mt-20 mx-auto text-primaryText bg-primaryBg rounded-md hover:scale-105 ease-in duration-300"
            initial={{ opacity: 0}}
            animate={{ opacity: 1}}
